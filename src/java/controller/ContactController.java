...
/**
 * Through the data access layer, this class gets contact information from the
 * database by calling methods from GalleryDAO's object and ContactDAO's object.
 * After that, this class will push all the data to "Contact.jsp". This class
...
public class ContactController extends HttpServlet {
    ...
    /**
     * This method gets contact information from the database by calling methods
     * from GalleryDAO's object then push all the data to "Contact.jsp". This
     ...
     *
     * @param request stores attributes listGallery, contact, error, errorDetail
     * and send to a web page. It is a
